...
// module.exports = { sequelize,PurchaseOrder };
module.exports = { sequelize, User, UserRole, Inquiry, Permission, Product, ProductPrices,Quotation, QuotationProduct,InquiryProduct,QuotationRevision,PurchaseOrder,QuotationReviced};
